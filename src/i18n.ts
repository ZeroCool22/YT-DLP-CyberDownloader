...
export const copy = {
  es: {
    ...
    rateLimitHelp: "YouTube limitó temporalmente las solicitudes (HTTP 429). Probá activar las cookies y elegí el navegador donde tengas iniciada sesión en YouTube.",
  ...
  en: {
    ...
    rateLimitHelp: "YouTube temporarily limited the requests (HTTP 429). Try enabling cookies and select the browser where you are signed in to YouTube.",
