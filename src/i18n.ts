...
export const copy = {
  es: {
    ...
    installedVersion: "Versión instalada", unknownVersion: "Desconocida", alreadyUpdated: "yt-dlp ya tiene la última versión disponible.",
    updatedSuccessfully: "yt-dlp se actualizó correctamente.", updateChecked: "La comprobación de actualizaciones finalizó correctamente.",
  ...
  en: {
    ...
    installedVersion: "Installed version", unknownVersion: "Unknown", alreadyUpdated: "yt-dlp is already on the latest available version.",
    updatedSuccessfully: "yt-dlp was updated successfully.", updateChecked: "The update check completed successfully.",
